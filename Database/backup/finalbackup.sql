...
INSERT INTO `lecture` VALUES (1,'A','BECS11234','2025-01-26','07:02:57','07:02:58'),(2,'dd','BECS11234','2025-01-26','08:00:00','10:00:00'),(3,'dd','BECS11234','2025-01-20','10:00:00','12:00:00'),(4,'cc','BECS11234','2025-01-20','10:00:00','12:00:00'),(5,'vdc','BECS11234','2025-01-22','10:00:00','13:00:00'),(6,'sdd','BECS11234','2025-01-19','12:00:00','13:00:00'),(7,'fffd','BECS11234','2025-01-20','16:00:00','18:00:00'),(8,'','BECS11234','2025-01-27','08:00:00','10:00:00');
...
INSERT INTO `lecture_has_lecture_hall` VALUES (1,6,1,'12:00:00','13:00:00','2025-10-03'),(2,7,3,'16:00:00','18:00:00','2025-06-01'),(3,8,1,'08:00:00','10:00:00','2025-01-27');
...
CREATE TABLE `medical` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_medical_student1_idx` (`student_id`),
  KEY `fk_medical_admin1_idx` (`admin_id`),
  CONSTRAINT `fk_medical_admin1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`),
  CONSTRAINT `fk_medical_student1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=90964 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `medical` VALUES (56752,'2025-01-23',1,60,1),(73579,'2025-01-22',1,17,1),(90963,'2025-01-24',2,60,1);
...
INSERT INTO `message` VALUES (1,'1','1','1','2025-01-24 12:23:50',0),(2,'A','A','A','2025-01-24 12:23:50',0),(3,'DM/2022/004','DM/2022/004','HAI','2025-01-24 23:51:08',1),(4,'DM/2022/004','DM/2022/004','A PATIYOOO','2025-01-24 23:52:35',1),(5,'DM/2022/004','LEC/2020/012','DD','2025-01-25 00:51:42',0),(6,'DM/2022/004','DM/2022/004','KOHOMADA','2025-01-25 00:55:48',1),(7,'EC/2022/001','EC/2022/001','hai','2025-01-26 06:34:46',0),(8,'induranga','DM/2022/004','AAA PATIYOOOO','2025-01-26 08:47:57',1);
...
INSERT INTO `module_has_demonstrator` VALUES (1,'BECS11234',1),(2,'BECS11342',2),(3,'BECS12345',4);
...
INSERT INTO `student_has_lecture` VALUES (1,11,6,0),(2,12,6,0),(3,13,6,0),(4,14,6,0),(5,15,6,0),(6,16,6,0),(7,17,6,0),(8,18,6,0),(9,19,6,0),(10,20,6,0),(11,21,6,0),(12,22,6,0),(13,23,6,0),(14,24,6,0),(15,25,6,0),(16,26,6,0),(17,27,6,0),(18,28,6,0),(19,29,6,0),(20,30,6,0),(21,31,6,0),(22,32,6,0),(23,33,6,0),(24,34,6,0),(25,35,6,0),(26,36,6,0),(27,37,6,0),(28,38,6,0),(29,39,6,0),(30,40,6,0),(31,41,6,0),(32,42,6,0),(33,43,6,0),(34,44,6,0),(35,45,6,0),(36,46,6,0),(37,47,6,0),(38,48,6,0),(39,49,6,0),(40,50,6,0),(41,51,6,0),(42,52,6,0),(43,53,6,0),(44,54,6,0),(45,55,6,0),(46,56,6,0),(47,57,6,0),(48,58,6,0),(49,59,6,0),(50,60,6,0),(51,61,6,0),(52,62,6,0),(53,63,6,0),(54,84,6,0),(55,11,7,0),(56,12,7,0),(57,13,7,0),(58,14,7,0),(59,15,7,0),(60,16,7,0),(61,17,7,0),(62,18,7,0),(63,19,7,0),(64,20,7,0),(65,21,7,0),(66,22,7,0),(67,23,7,0),(68,24,7,0),(69,25,7,0),(70,26,7,0),(71,27,7,0),(72,28,7,0),(73,29,7,0),(74,30,7,0),(75,31,7,0),(76,32,7,0),(77,33,7,0),(78,34,7,0),(79,35,7,0),(80,36,7,0),(81,37,7,0),(82,38,7,0),(83,39,7,0),(84,40,7,0),(85,41,7,0),(86,42,7,0),(87,43,7,0),(88,44,7,0),(89,45,7,0),(90,46,7,0),(91,47,7,0),(92,48,7,0),(93,49,7,0),(94,50,7,0),(95,51,7,0),(96,52,7,0),(97,53,7,0),(98,54,7,0),(99,55,7,0),(100,56,7,0),(101,57,7,0),(102,58,7,0),(103,59,7,0),(104,60,7,0),(105,61,7,0),(106,62,7,0),(107,63,7,0),(108,84,7,0),(109,11,8,1),(110,12,8,1),(111,13,8,2),(112,14,8,1),(113,15,8,2),(114,16,8,1),(115,17,8,1),(116,18,8,1),(117,19,8,2),(118,20,8,1),(119,21,8,2),(120,22,8,2);
...
-- Dump completed on 2025-01-26  9:54:06
