...
public class DBConnectDemo extends DBConnect{
        ...
        try{
            ...
            while(rs.next()){
                if(rs.getString("demonstrator_id").equals(username) && rs.getString("contact_no").equals(password)){
                    System.out.println(rs.getString("demonstrator_id").equals(username) && rs.getString("contact_no").equals(password));
//                    System.out.println(password);
//                    System.out.println(rs.getString("demonstrator_id"));
